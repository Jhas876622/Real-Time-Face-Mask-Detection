...
# ✅ FIX 1: Use absolute paths so it works on any server (Render, local, etc.)
BASE = os.path.dirname(__file__)

model = load_model(os.path.join(BASE, "model", "mask_detector.h5"))
...
# ✅ FIX 2: Read PORT from environment variable (required by Render)
